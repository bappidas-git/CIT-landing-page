/* ============================================
   ...
   "Contact / Admissions" — how to reach the CIT
   admission office. No form: /apply is the only
   lead-capture surface on the site.
   ============================================ */
        ...
        >
          ...
          <motion.div variants={itemVariants} className={styles.sectionHeader}>
            ...
            <Typography variant="body1" className={styles.sectionSubtitle}>
              Reach us directly by call or WhatsApp — we&rsquo;ll explain how
          ...
          {/* Contact Cards — the section's whole width since the enquiry form
              was removed; /apply is the only lead-capture surface. */}
